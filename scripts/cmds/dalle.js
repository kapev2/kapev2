...
if (!keySearch) return message.reply("Add something baka.");
    ...
    try {
        const res = await axios.get(`https://api-turtle.onrender.com/api/dalle?prompt=${keySearch}&cookie=1z29WfVE58SMtcc32aIaOYN-x8WVWSvuVWOyyNRgEcdaFvAhBsqEfDl-0dBiWTnGyjvuqk9nXG1uag8pHloaw2dvVtDOpYl3zQm6bXPN48axb9k_fsdVL8WR6WxsiHTPqI8GHPL97jEomFbZdZ4Tffcc21VfGt4oY_bCwtJbFP9RXhy0LUSLwmXUxPt5ELOIK03p1rgwvKFwfaz8MvPpX1VRB2LqT0tt_a70NmzR8LWo`);// add your bing cookie _u value!!
